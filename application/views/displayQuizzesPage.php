...
<head>
    ...
    <title>Search Results-QuizzableQuizzes.com</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h3> <small>Matching Quizzes</small></h3>
            </div>
        </div>
        ...
        <?php
            ...
            if(count($quizzes)==0){
                echo '<div class="row" style="margin-right: 40%;height:10%;">'
                    . 'No matches found. </div>';
            }
            else{
                for($i=0;$i<count($quizzes);$i++){
                echo   '<form id="form'.$quizzes[$i]->getId().'" action="initializeQuiz" method="POST">'
